  ...
  return (
    <div className="relative group">
      ...
      <Link
        ...
        scroll={false}
      >
        <div className="relative rounded-xl overflow-hidden aspect-[316/350] bg-gray-card">
...
export const ProductCardUi4Loading = () => (
