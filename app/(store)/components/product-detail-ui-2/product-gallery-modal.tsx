            ...
            <SwiperSlide key={image.img}>
              <div className="flex justify-center">
                <MediaRender
                  ...
                  width={411}
                  className="rounded-2xl md:aspect-[411/609] aspect-[1/3] max-h-96 sm:max-h-none md:w-auto md:object-cover object-contain w-full"
                  height={609}
                />
              </div>
            </SwiperSlide>
              ...
              {data?.map((image, i) => (
                <SwiperSlide className="max-w-max" key={image.img}>
                  <Image
                    ...
                    className={clsx(
                      "rounded-full aspect-square w-11 h-11 object-cover my-2 mr-2 flex justify-center",
                      i === 0 && "ml-2"
                    )}
                    alt={image.color?.value || ""}
                    width={44}
