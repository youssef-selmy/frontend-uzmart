      ...
      >
        ...
        >
          ...
          <div className={clsx(fullPage ? "xl:col-span-2 lg:col-span-3 col-span-7" : "mt-8")}>
            ...
            <div className="border border-gray-border rounded-2xl p-4 mt-5 flex items-center justify-between dark:border-gray-inputBorder">
        ...
        {!fullPage && (
          <div className="flex justify-center mt-6">
            <Link
              href={`/products${
                settings?.ui_type === "1" || !settings?.ui_type ? "" : `-${settings?.ui_type}`
              }/${data?.uuid}`}
              target="_blank"
              rel="noreferrer"
