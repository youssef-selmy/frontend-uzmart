  ...
  return (
    <div
      className={clsx(
        "flex flex-col gap-7",
        inDrawer && "px-2 pb-20",
        !inDrawer && "w-[290px] sticky top-2 pr-4 pb-4 rtl:pr-0 rtl:pl-4",
    ...
    >
        ...
        <>
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col overflow-hidden">
              <strong className="text-lg font-semibold text-ellipsis whitespace-nowrap">
                {data?.data?.firstname} {data?.data?.lastname?.slice(0, 1)}
              </strong>
              <span className="text-sm text-gray-field text-ellipsis whitespace-nowrap">
                {data?.data?.email}
              </span>
            </div>
          </div>
      ...
      {links.map((link) => {
        ...
        return (
          <div key={link.title}>
            <h6 className="text-xs font-medium mb-2 uppercase">{t(link.title)}</h6>
